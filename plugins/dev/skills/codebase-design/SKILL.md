...
Use these terms exactly; the _Avoid_ list on each entry names the words it replaces.
...
- **Deepen by shrinking the interface.** Ask of each design: can a method go, can a parameter simplify, can more complexity hide behind the same surface?
